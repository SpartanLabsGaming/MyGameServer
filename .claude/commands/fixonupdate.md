...
- Current dependency: `io.github.spartanlaboratories:GameTools` in `build.gradle.kts`
  (line with `implementation("io.github.spartanlaboratories:GameTools:<version>")`).
- Poll Maven Central for the latest version, e.g.:
  `https://repo1.maven.org/maven2/io/github/spartanlaboratories/GameTools/maven-metadata.xml`
...
- When a newer version appears:
  ...
  3. Diff the sources jar old vs new to find API changes:
     `C:\Users\spart\.gradle\caches\modules-2\files-2.1\io.github.spartanlaboratories\GameTools\<version>\*\GameTools-<version>-sources.jar`
